...
@section('content')
 ...
 <section id="wrapper" class="login-register" style="background-image:url({{authBanner()}});">
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-material text-center" id="loginform" method="POST" action="{{ route('login') }}">
                    ...
                    <a href="javascript:void(0)" class="db">
                        <h3 style="color:#cc0066"><b>DEPARTMENT USERS PORTAL</b></h3>
                    </a>
                        <br/>
                    ...
                    <div class="form-group m-t-40">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" required="" name="username" value="{{old('username')}}" placeholder="{{ __('Username') }}">
                        </div>
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-info btn-lg btn-block text-uppercase btn-rounded" style="background-color:#cc0066; color:white" type="submit">{{ __('Login') }}</button>
                        </div>
                    </div>
