...
@section('title', 'List Division')
@section('content')
<div class="page-wrapper">
   <div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Divisions</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a class="btn btn-info d-ntone d-lg-block m-l-15" href="{{route('divisions.create')}}"><i class="fa fa-plus-circle"></i> Create New</a>
            </div>
        </div>
    </div>
      <div class="row">
                              ...
                              <table class="table table-hover">
                                 ...
                                 <tbody>
                                  ...
                                  @foreach($results as $result)
                                    <tr>
                                       <td>{{$result->name ?? ''}}</td>
                                       <td>{{$result->parent_division->name ?? '--'}}</td>
                                       <td>
                                        @if(isset($result->status) && $result->status == _active())
                                      ...
                                      <td>
                                       {{-- <a class="waves-effect waves-dark" href="{{route('divisions.show',$result->id)}}" data-toggle="tooltip" data-original-title="View Division"><i class="fa fa-eye"></i></a>
                                    &nbsp;&nbsp;&nbsp; --}}
                                       <a class="waves-effect waves-dark" href="{{route('divisions.edit',$result->id)}}" data-toggle="tooltip" data-original-title="Edit Division"><i class="fa fa-edit"></i></a>
