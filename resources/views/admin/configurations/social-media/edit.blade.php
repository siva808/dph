    ...
    <div class="container" style="margin-top: 90px;">
        <div class="container-fluid p-2" style="background-color: #f2f2f2;">
            <div class="d-flex justify-content-between align-items-center" style="padding-left: 20px; padding-right: 20px;">
                <h5 class="mb-0">Edit SocialMedia</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0" style="background-color: #f2f2f2;">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit SocialMedia</li>
                    </ol>
                </nav>
                    ...
                    <div class="container mt-2">
                        <div class="row">
                            <div class="col-lg-12 p-5" style="background-color: #ffffff; border-radius: 10px;">
                                <form id="myForm" action="{{ route('social-media.update', $result->id) }}" enctype="multipart/form-data"
                                    method="post">
                                    {{ csrf_field() }}
                                    @method('PUT')
                                    <div class="container">
                                        <h4 class="card-title mb-4 text-primary">Edit SocialMedia</h4>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12 col-md-7">
                                                <input type="file" class="form-control" name="social_media_image"
                                            ...
                                            <div class="col-12 col-md-2">
                                                <img id="imagePreview" src="{{ fileLink($result->image_url) }}"
                                                    alt="Image Preview" class="img-fluid"
                                                    onclick="showImageModal('imagePreview')"
                                    ...
                                    <div class="d-flex mt-2 pl-5">
                                        ...
                                        <button type="button" style="margin-left: 10px;" onclick="window.location.href='{{url('/social-media')}}';"
