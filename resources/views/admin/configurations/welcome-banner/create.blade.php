    ...
    <div class="container" style="margin-top: 90px;">
        <div class="container-fluid p-2" style="background-color: #f2f2f2;">
            <div class="d-flex justify-content-between align-items-center" style="padding-left: 20px; padding-right: 20px;">
                <h5 class="mb-0">Create Welcome Banners</h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0" style="background-color: #f2f2f2;">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Create Welcome Banner</li>
                    </ol>
                </nav>
                    ...
                    <div class="container mt-2">
                        <div class="row">
                            <div class="col-lg-12 p-5" style="background-color: #ffffff; border-radius: 10px;">
                                <form id="myForm" action="{{ route('welcome-banner.store') }}" enctype="multipart/form-data" method="post" id="myForm">
                                    {{ csrf_field() }}
                                    <div class="container">
                                        <h4 class="card-title mb-4 text-primary">Create Welcome Banners</h4>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12 col-md-3">
                                                <label for="profileImage" class="form-label">Welcome Banner Image<span
                                                        class="sizeoftextred">*</span></label>
                                            </div>
                                            <div class="col-12 col-md-7">
                                                <input type="file" class="form-control" id="profileImage"
                                                    accept="image/*" name="welcome_image" required>
    ...
    <script>
      ...
      <script>
        ...
        document.getElementById('imagePreview').addEventListener('click', function () {
          const imageModal1 = new bootstrap.Modal(document.getElementById('imageModal1'));
          imageModal1.show();
        });
      </script>
@endsection
