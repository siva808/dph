    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a class="btn btn-info d-ntone d-lg-block m-l-15" href="{{route('testimonials.create')}}"><i class="fa fa-plus-circle"></i> Create New</a>
                                 ...
                                 <tbody>
                                  ...
                                  @foreach($results as $result)
                                    <tr>
                                      ...
                                      <td>
                                       <a class="waves-effect waves-dark" href="{{route('testimonials.show',$result->id)}}" data-toggle="tooltip" data-original-title="View Testimonial"><i class="fa fa-eye"></i></a>
                                    &nbsp;&nbsp;&nbsp;
                                        <a class="waves-effect waves-dark" href="{{route('testimonials.edit',$result->id)}}" data-toggle="tooltip" data-original-title="Edit Testimonial"><i class="fa fa-edit"></i></a>
