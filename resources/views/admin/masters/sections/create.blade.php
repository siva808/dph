   ...
   <div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Create Facility Type</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Create Facility Type</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <form action="{{route('facilitytypes.store')}}" enctype="multipart/form-data" method="post">
                        {{csrf_field()}}
                    ...
                    <div class="row pt-3">
                        ...
                        <div class="form-group col-sm-4 col-xs-4">
                            <label for="facilitytype" class="">Select Image</label>
                            <input type="file" name="facilitytype_image" class="form-control" id="facilitytype_image accept="image/png,image/jpg,image/jpeg">
