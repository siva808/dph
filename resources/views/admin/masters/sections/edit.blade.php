            ...
            <div class="container-fluid mt-2">
                <div class="row">
                    <div class="col-lg-12 p-5" style="background-color: #ffffff; border-radius: 10px;">
                        ...
                        <div class="card-body">
                            <!-- Heading -->
                            <h4 class="card-title mb-4 text-primary">Edit Section Details</h4>

                            <form action="{{ route('sections.update', $result->id) }}" enctype="multipart/form-data"
                                method="post">
                                {{ csrf_field() }}
                                @method('PUT')
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="sectiontype" name="name" value="{{ old('name', $result->name) }}"
                                            required>
                                    </div>
