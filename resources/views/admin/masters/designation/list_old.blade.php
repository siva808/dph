    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a class="btn btn-info d-ntone d-lg-block m-l-15" href="{{route('designations.create')}}"><i class="fa fa-plus-circle"></i> Create New</a>
            </div>
        </div>
    </div>
      <div class="row">
                              ...
                              <table class="table table-hover">
                                 ...
                                 <tbody>
                                  ...
                                  @foreach($results as $result)
                                    <tr>
                                       <td>{{$result->name ?? ''}}</td>
                                       <td>{{$result->designation_type->name ?? '--'}}</td>
                                       <td>
                                      ...
                                      <td>
                                       <a class="waves-effect waves-dark" href="{{route('designations.show',$result->id)}}" data-toggle="tooltip" data-original-title="View Designation"><i class="fa fa-eye"></i></a>
                                    &nbsp;&nbsp;&nbsp;
                                        <a class="waves-effect waves-dark" href="{{route('designations.edit',$result->id)}}" data-toggle="tooltip" data-original-title="Edit Designation"><i class="fa fa-edit"></i></a>
