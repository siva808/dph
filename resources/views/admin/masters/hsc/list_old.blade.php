        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Hsc</li>
                </ol>

                 @if (isAdmin())
                <a class="btn btn-info d-ntone d-lg-block m-l-15" href="{{route('hsc.create')}}"><i class="fa fa-plus-circle"></i> Create New</a>
                @endif
            </div>
        </div>
    </div>
                                 ...
                                 <tbody>
                                  ...
                                  @foreach($results as $result)
                                    <tr>
                                      ...
                                      <td>
                                       <a class="waves-effect waves-dark" href="{{route('hsc.show',$result->id)}}" data-toggle="tooltip" data-original-title="View HSC"><i class="fa fa-eye"></i></a>
                                    &nbsp;&nbsp;&nbsp;
                                        <a class="waves-effect waves-dark" href="{{route('hsc.edit',$result->id)}}" data-toggle="tooltip" data-original-title="Edit HSC"><i class="fa fa-edit"></i></a>
